...
Dependencies:
- sensitivity_functions.R
- model_ODE.R
- model_ODE_cueMOD.R
- model_ODE_modAK.R

Workflow:
- Read in data from one site stored in .csv
- Process that data and retrieve relavant information for each variable
- Run the model function parallel to the finishing function
- Run three sensitviity functions independtly and output results to .csv
- Move forwards with evaluation in seperate files.
